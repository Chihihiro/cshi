...
class my_test(My_Tests):
    ...
    def main(self):
        try:
            ...
            self.wait_xpath('//android.widget.TextView[@text="搜索"]').click()
            self.wait_xpath('//hierarchy/android.widget.FrameLayout[1]/android.widget.LinearLayout[1]/android.widget.FrameLayout[1]/android.widget.RelativeLayout[1]/android.support.v7.widget.RecyclerView[1]/android.widget.LinearLayout[1]/android.widget.LinearLayout[1]/android.widget.TextView[1]').click()
